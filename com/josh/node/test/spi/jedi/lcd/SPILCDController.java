...
public abstract class SPILCDController implements DisplayDevice {
	...
	public void init(DisplayDeviceDescriptor desc) throws InvalidDeviceDescriptorException, IOException {
		...
		if (desc instanceof SPILCDDeviceDescriptor) {
			...
			SPIDevice spi = getSPIDevice(spi_lcd_desc.getSPIControllerNumber(), spi_lcd_desc.getCSAddress(),
					spi_lcd_desc.getClockFrequency(), spi_lcd_desc.getClockMode(), spi_lcd_desc.getWordLength(),
