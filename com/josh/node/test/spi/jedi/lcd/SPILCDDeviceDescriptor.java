...
public class SPILCDDeviceDescriptor implements DisplayDeviceDescriptor {
	...
	public SPILCDDeviceDescriptor(String classNameOfDriver, int SPIControllerNumber, int CSAddress, int clockFrequency,
			int clockMode, int wordLength, int bitOrdering, int csActiveLevel) {
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof SPILCDDeviceDescriptor) {
			...
			if (another.driverName.equals(driverName) && (another.SPIControllerNumber == SPIControllerNumber)
